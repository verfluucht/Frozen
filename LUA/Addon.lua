...
local function Talents()
	...
	PlayerStatFrame[1].t:SetColorTexture(Tier[1], Tier[2],Tier[3], alphaColor) -- col 2
	PlayerStatFrame[2].t:SetColorTexture(Tier[4],Tier[5],Tier[6], alphaColor)  -- col 3
	PlayerStatFrame[3].t:SetColorTexture(Tier[7],Race[select(2,UnitRace("player"))],0, alphaColor) -- col 4
	--print("Current Spec ID:" .. currentSpecId .. " Red = " .. Spec.Id[currentSpecId])
	PlayerStatFrame[4].t:SetColorTexture(Spec.Id[currentSpecId], EquipmentManger.T19/100, EquipmentManger.T20/100, alphaColor) -- col 5
	PlayerStatFrame[5].t:SetColorTexture(EquipmentManger.Legendary1,EquipmentManger.Legendary2,0, alphaColor) -- col 6
end
